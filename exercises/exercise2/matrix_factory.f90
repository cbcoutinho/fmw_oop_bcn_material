...
module matrix_factory_mod
  ...
  use dense_matrix_mod,     only: dense_matrix_t
  use band_matrix_mod,      only: band_matrix_t
  use sym_band_matrix_mod,  only: sym_band_matrix_t
  use sparse_matrix_mod,    only: sparse_matrix_t
